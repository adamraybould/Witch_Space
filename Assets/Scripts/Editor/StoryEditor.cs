...
public class StoryEditor : EditorWindow
{
    ...
    private DialogueData storyData;
    private View _view;
    ...
    void OnGUI()
    {
        if (storyData != null)
        {
            SerializedObject dataObj = new SerializedObject(storyData);
    ...
    private void OnGUI_DataView()
    {
        EditorGUILayout.Space();
        EditorGUILayout.BeginHorizontal();
        EditorGUILayout.LabelField("Current Dialogue Data");
        storyData = (DialogueData)EditorGUILayout.ObjectField(storyData, typeof(DialogueData), false);
    ...
    private void OnGUI_BeatViewChoice(SerializedProperty choiceList, int index, SerializedProperty beatList)
    {
        ...
        beatId.intValue = (int)EditorGUILayout.IntField("Leads to Beat ID: ", beatId.intValue);
